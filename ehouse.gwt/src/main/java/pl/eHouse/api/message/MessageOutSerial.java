 ...
 * @author Bartek
 */
public class MessageOutSerial extends MessageOut {

    private String serial;
    private String data; 

    public MessageOutSerial(Id id, Command command, String owner) {
        super(Header.SERIAL, id, command, owner);
        this.data = "";
